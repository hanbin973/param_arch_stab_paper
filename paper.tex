...
\begin{abstract}
    ...
    Next, we account for pleiotropy and show that functional annotations acts on variance components through trait-fitness genetic correlation.
\end{abstract}
...
Throw config.yaml and .slim to genAI?

\subsection{Variance component estimation}

Restricted maximum likelihood (REML) is a standard tool to estimate variance components in quantitative genetics [cite].

Fit mixed model and get estimate with different parameterizations.
Several $\alpha$ models could help?



\subsection{Genetic prediction}
Fit mixed model and get blup with different parameterizations
