...
\reply{
Figure X-X draws the requested curve alongside two $\alpha$-model variants with or without MAF-binning.
}
...
Figure X-X are precisely the analogous plot to Schoech's supplementary figure.
}
...
We have updated Discussion to reflect these results.
